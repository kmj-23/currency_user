...
public class ExchangeController {
    ...
    @GetMapping("/{userId}")
    public ResponseEntity <List<ExchangeResponseDto>> findAllExchangesByUserId(@PathVariable Long userId){// <List<>> ??
        List<ExchangeResponseDto> exchangeResponseDto = exchangeService.findAllExchangesByUserIdOrElseThrow(userId);
